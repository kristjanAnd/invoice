    ...
    [
        ...
        'actions' => [
            [
                ...
                'key' => 'Controller.article.action.article-setting',
                'is_navigation' => true,
                'order_no' => -1,
            ],
            [
                'name' => 'edit-article-setting',
                'key' => 'Controller.article.action.edit-article-setting',
                'is_navigation' => false,
                'order_no' => 0,
            ],
            [
            ...
            [
                'name' => 'vat',
                'key' => 'Controller.article.action.vat',
                'is_navigation' => true,
                'order_no' => 16,
            ],
            [
                'name' => 'add-vat',
                'key' => 'Controller.article.action.add-vat',
                'is_navigation' => false,
                'order_no' => 17,
            ],
            [
                'name' => 'edit-vat',
                'key' => 'Controller.article.action.edit-vat',
                'is_navigation' => false,
                'order_no' => 18,
            ],
        ]
